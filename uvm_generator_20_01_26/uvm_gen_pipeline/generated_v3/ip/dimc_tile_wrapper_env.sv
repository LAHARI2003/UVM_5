...
// Connects all virtual interfaces and analysis ports per UVM methodology
...
class dimc_tile_wrapper_env extends uvm_env;
  ...
  // Scoreboard
  dimc_tile_wrapper_scoreboard#(64) scoreboard;
  ...
  function void build_phase(uvm_phase phase);
    ...
    scoreboard           = dimc_tile_wrapper_scoreboard#(64)::type_id::create("scoreboard", this);

    // Get all virtual interfaces from config_db
  ...
  function void connect_phase(uvm_phase phase);
    ...
    // Connect virtual interfaces to agents and drivers
    ...
    m_kernel_mem_env.m_agent.m_monitor.vif = kernel_mem_vif;

    m_addin_env.m_agent.vif           = addin_vif;
    m_addin_env.m_agent.m_driver.vif  = addin_vif;
    m_addin_env.m_agent.m_monitor.vif = addin_vif;

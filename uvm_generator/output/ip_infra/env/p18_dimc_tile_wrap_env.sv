...
class p18_dimc_tile_wrap_env extends uvm_env;
  ...
  function void build_phase(uvm_phase phase);
    ...
    if (!uvm_config_db#(virtual regbank_if)::get(this, "", "compu_vif", compu_vif))
      `uvm_fatal("NOVIF", "Virtual interface must be set for compu_vif")
  ...
  function void connect_phase(uvm_phase phase);
    ...
    m_computation_env.m_agent.vif                    = compu_vif;
    m_computation_env.m_agent.m_driver.vif           = compu_vif;
    m_computation_env.m_agent.m_monitor.vif          = compu_vif;
